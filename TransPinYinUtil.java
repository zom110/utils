...
/**
 * 中文转拼音的工具类
 * @ClassName: TransPinYinUtil 
 * @author Administrator
 * @date 2015-1-21 下午7:21:38 
 * @history 
 *
 */
public class TransPinYinUtil {
	...
	private int getChsAscii(String chs) {
		...
		try {
			...
			System.out.println("FAIL:ChineseSpelling.class-getChsAscii(String chs)" + e);
			// e.printStackTrace();
		}
		return asc;
	}
	 ...
	 * @return
	 */
	public String convertAll_py(String str) {
		String result = "";
		String strTemp = null;
	 ...
	 * @return
	 */
	public String getStringSpellingFirstLetter(String str) {
		...
		return String.valueOf(result.subSequence(0, 1));
	}

	public String convertAll_jp(String str) {
		String result = "";
		String strTemp = null;
		for (int j = 0; j < str.length(); j++) {
			strTemp = str.substring(j, j + 1);
			...
			if (ascii > 0 && ascii < 160) {
				...
				for (int i = (pyvalue.length - 1); i >= 0; i--) {
					if (pyvalue[i] <= ascii) {
						result += pystr[i].subSequence(0, 1);
						break;
					}
				}
			}
	...
	public String trans2PinYin(String str) {
		return this.convertAll_py(str);
	}

	public String trans2PinYin_jp(String str) {
		return this.convertAll_jp(str);
	}
}
